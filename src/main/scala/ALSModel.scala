...
class ALSModel extends Serializable {
  ...
  private val TRAINING_DATA_IN_PATH = "hdfs://pubgame/user/vincent/SparkAls/pg_user_game_90_training_v2.csv"
  private val TEST_DATA_IN_PATH = "hdfs://pubgame/user/vincent/SparkAls/pg_user_game_90_test_v2.csv"
